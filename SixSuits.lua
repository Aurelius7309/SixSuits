...
function SMODS.INIT.SixSuit()
    ...
    function Game:init_game_object()
        ...
        t.hands = {
            ...
            ["Spectrum"] = { visible = true, order = 12, mult = 3, chips = 35, s_mult = 3, s_chips = 35, level = 1, l_mult = 2, l_chips = 25, played = 0, played_this_round = 0, example = { { 'H_2', true }, { 'D_5', true }, { 'S_8', true }, { 'C_T', true }, { 'R_A', true } } },
