--- NOT STEAMODDED HEADER
--- MOD_NAME: Six Suits
--- MOD_ID: OldSixSuits
--- MOD_AUTHOR: [Aure, CrimsonHeart]
--- MOD_DESCRIPTION: This mod adds two new suits to the game. They can be enabled when starting a game using all registered decks. LEGACY VERSION, FOR USE WITH STEAMODDED 0.6.2 OR LOWER

----------------------------------------------
------------MOD CODE -------------------------
function SMODS.INIT.SixSuit()
    local six_suit_mod = SMODS.findModByID('OldSixSuits')
